...
export const Plot1Data = [13, 14, 15, 16, 17, 18, 12, 221, 222, 223, 224, 225, 11, 10, 9, 8, 7, 6];
...
export const Plot4Data = [5, 115, 45, 4, 114, 46, 3, 113, 47, 2, 112, 48, 1, 111, 49, 52, 51, 50];
export const SafeSpots = [
    221, 222, 223, 224, 225, 14, 27, 331, 332, 333, 334, 335, 40, 441, 442, 443, 444, 445, 1, 111,
    112, 113, 114, 115,
];
...
export const colorPlayer = [colors.red, colors.green, colors.yellow, colors.blue];
